...
// react-pdf compatible border helpers
...
const TaxCertificatePDF = ({ record }) => {
  const { contact_name, tax_id, address, income_type, amount_before_tax, tax_rate, tax_amount, date } = record;
      ...
      <Page size="A4" style={s.page}>
        ...
        <View style={s.hdrWrap}>
          ...
          <View style={s.hdrRight}>
            <View style={s.hdrRightRow}>
              <Text style={s.fs10}>เล่มที่ </Text>
              <View style={[s.dottedFixed, {width: 70}]} />
            </View>
            <View style={s.hdrRightRow}>
        ...
        <View style={s.secBox}>
          <View style={s.secRow}>
            ...
            <View style={{width: 6}} />
            <TaxIdBoxes taxId="0105555555555" />
          </View>
          ...
          <View style={s.secRow}>
            ...
            <View style={{flex: 1, position: 'relative'}}>
              ...
              <Text style={{position: 'absolute', bottom: 1, left: 8, fontSize: 11}}>บริษัท ทดสอบระบบ จำกัด</Text>
            </View>
            <View style={{width: 10}} />
          ...
          <View style={s.secRow}>
            ...
            <View style={{flex: 1, position: 'relative'}}>
              <View style={s.dottedLine} />
              <Text style={{position: 'absolute', bottom: 1, left: 8, fontSize: 11}}>123 ถ.สุขุมวิท กรุงเทพฯ</Text>
            </View>
          </View>
        ...
        <View style={s.chkSec}>
          ...
          <View style={s.chkRow}>
            ...
            <CB label="(5) ภ.ง.ด.2ก" />
            <CB label="(6) ภ.ง.ด.3ก" />
            <CB label="(7) ภ.ง.ด.53" checked={true} />
          </View>
        </View>
        ...
        <View style={s.tbl}>
          ...
          <View style={s.tRow}>
            ...
            <View style={s.tdDate} /><View style={s.tdAmt} /><View style={s.tdTax} />
          </View>
          ...
          {/* Row 4 - complex dividends section */}
          <View style={s.tRow}>
            <View style={s.tdDesc}>
          ...
          <View style={s.tRow}>
            <View style={s.tdDesc}>
              <View style={{flexDirection: 'row', alignItems: 'flex-end'}}>
                ...
                <View style={s.dottedLine}>
                  <Text style={{fontSize: 11}}>{income_type}</Text>
                </View>
              </View>
            </View>
            <View style={s.tdDate}><Text>{date}</Text></View>
            <View style={s.tdAmt}><Text>{fmtAmt(amount_before_tax)}</Text></View>
            <View style={s.tdTax}><Text>{fmtAmt(tax_amount)}</Text></View>
          </View>
        ...
        <View style={s.footWrap}>
          ...
          <View style={s.footSign}>
            ...
            <View style={{marginTop: 8}}>
              <Text style={s.fs9}>(วัน เดือน ปี ที่ออกหนังสือรับรองฯ)</Text>
            </View>
            {/* Stamp circle */}
